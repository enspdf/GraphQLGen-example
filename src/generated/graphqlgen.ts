...
export namespace MutationResolvers {
  ...
  export interface ArgsCreatePet {
    name: string;
    age: number;
  }
...
export namespace PetResolvers {
  export const defaultResolvers = {
    name: (parent: Pet) => parent.name,
    age: (parent: Pet) => parent.age
  };
